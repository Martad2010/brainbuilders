        ...
        <div className="w-full px-0 lg:px-12 xl:w-[80%]">
          ...
          {!type && (
            <>
              ...
              <p className="satoshi font-medium text-black/80">
              ...
              <br />
              {/* definitions */}
              <h3 className="font-switch font-bold text-black">Definitions</h3>
              ...
              <p className="satoshi mt-2 font-medium text-black/80">
                ...
                or other securities entitled to vote for the election of
                directors or other managing authority.
              </p>
              <p className="satoshi mt-2 font-medium text-black/80">
                Company (referred to as either &quot;the Company&quot;,
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
                Agreement) refers to MARTAD EDU $ SKILLS, 3B ALEGBE CLOSE,
              ...
              <p className="satoshi mt-2 font-medium text-black/80">
                Website refers to: https://mybrain-builder.com/
              </p>
              <p className="satoshi mt-2 font-medium text-black/80">
              ...
              <ul>
                ...
                <li className="satoshi mt-2 font-medium text-black/80"></li>
              </ul>
              <br />
              <h3 className="font-switch font-bold text-black">Usage Data</h3>
              <p className="satoshi mt-2 font-medium text-black/80">
              ...
              <h3 className="font-switch mt-4 font-bold text-black">
                Type: Session Cookies
              </h3>
              <h3 className="font-switch mt-3 font-bold text-black">
                Administered by: Us
              </h3>
              <p className="satoshi mt-2 font-medium text-black/80">
              ...
              <p className="satoshi mt-2 font-medium text-black/80">
                ...
                you share personal information or otherwise interact in public
              ...
              <br />
              <h3 className="font-switch font-bold text-black">Contact Us</h3>
              <p className="satoshi mt-2 font-medium text-black/80">
